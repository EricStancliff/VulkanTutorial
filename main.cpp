...
private:
    ...
    {
        auto vertShaderCode = readShaderFile("C:\\My_Work\\Vulkan1\\shaders\\SimpleTriangle.vert.spv");
        auto fragShaderCode = readShaderFile("C:\\My_Work\\Vulkan1\\shaders\\SimpleTriangle.frag.spv");
